...
public class ProdDevEmp {
	...
	public ProdDevEmp(int id, String firstName, String lastName, String salary, int vacaAvailable, int vacaTaken,
	...
	public String toString() {
		return "ProdDevEmp [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", salary=" + salary
