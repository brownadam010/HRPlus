...
public class FinanceEmp {
	...
	public FinanceEmp(int id, String firstName, String lastName, String salary, int vacaAvailable, int vacaTaken,
	...
	public String toString() {
		return "FinanceEmp [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", salary=" + salary
