...
public class MarketingEmp {
	...
	public MarketingEmp(int id, String firstName, String lastName, String salary, int vacaAvailable, int vacaTaken,
			int vacaLeft, String investments) {
		this.id = id;
	...
	public String toString() {
		return "MarketingEmp [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", salary=" + salary
				+ ", vacaAvailable=" + vacaAvailable + ", vacaTaken=" + vacaTaken + ", vacaLeft=" + vacaLeft
